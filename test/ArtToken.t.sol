...
contract ArtTokenTest is Test {
    ...
    function setUp() public {
        ...
        // Deploy the artToken using the contract name
        artToken = new ArtToken(owner, "ART TOKEN", "ART", 1_000_000);

        // Attach the ArtToken interface to the deployed artToken
        artToken = ArtToken(artToken);
    ...
    function testMaxSupply() public {
        ...
        vm.prank(owner);
        vm.expectRevert(abi.encodeWithSelector(ERC20Capped.ERC20ExceededCap.selector, maxSupply + 1, maxSupply));
    ...
    function testMintExceedingMaxSupply() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(ERC20Capped.ERC20ExceededCap.selector, initialSupply + maxSupply, maxSupply)
        );
